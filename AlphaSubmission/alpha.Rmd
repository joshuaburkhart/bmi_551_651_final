...
kaggle.classes <- read.csv("../AlphaSubmission/example_result.txt", sep="", stringsAsFactors=FALSE)
...
zz <- file(description="~/bmi_551_651_final/alpha_out.txt",'w')
write.csv(kaggle.out,zz,row.names=FALSE)
close(zz)
